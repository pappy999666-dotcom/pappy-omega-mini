...
export function buildSessionMenu(
  ...
  const actions: MenuAction[] = [
    ...
    { id: "autojoin", label: "Join Manager", command: "autojoin", description: "Toggle the Active-bucket Join Manager; alias: jm on|off." },
    { id: "join", label: "Direct Join", command: "join", description: "Join one supplied WhatsApp invite link." },
