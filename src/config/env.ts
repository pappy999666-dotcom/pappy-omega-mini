...
const envSchema = z.object({
  ...
  BROADCAST_CONCURRENCY: z.coerce.number().int().positive().max(8).default(2),
  ...
  WORKLOAD_PACKAGE_VERSION: z.string().default("1.2.13"),
  ...
  WORKLOAD_RELEASE_VERSION: z.string().default("1.2.13"),
